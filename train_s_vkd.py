...
def main():
    ...
    parser.add_argument("--train_list", type=str, default="data_txt/CUMT_phase2_train.txt")
    parser.add_argument("--val_list", type=str, default="data_txt/CUMT_phase2_val.txt")
